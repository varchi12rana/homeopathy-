    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="bg-white p-8 rounded-lg shadow-sm border border-emerald-100 space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">You may request a return within 24-48 hours of receiving your order if:</p>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">For hygiene and safety reasons, we do not accept returns for:</p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Email us at <a href="mailto:homeovia.care@gmail.com" className="text-emerald-600 hover:underline">homeovia.care@gmail.com</a></li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>If a replacement product is available, we may offer a replacement instead of a refund. If the product is unavailable, a full refund will be issued.</li>
          </ul>
        </section>
